...
var
  fPR_ProductList: TfPR_ProductList;
  structureNum : String;
...
duPubP,fPR_PlanAddP;
 ...
 procedure TfPR_ProductList.initData();
 var
...
procedure TfPR_ProductList.Button2Click(Sender: TObject);
var
  listData : TStringList;
begin
    ...
    begin
        ...
        begin
          ...
          duPub.tbl_pu_seOrderPrBe.fieldbyname('status').AsString := 'Œ¥¡Ï¡œ';
          duPub.tbl_st_structureDt.next;
        end;
        duPub.tbl_pu_seOrderPrBe.ApplyUpdates(true,true);
    end;
    fPR_PlanAdd.Edit2.Text := structureNum;
    listData := TStringList.Create;
...
procedure TfPR_ProductList.cxGrid1DBTableView1CellClick(
...
procedure TfPR_ProductList.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TfPR_ProductList.FormCreate(Sender: TObject);
